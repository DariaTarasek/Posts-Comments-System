...
func (_m *PostService) CreatePost(ctx context.Context, post *model.Post) error {
...
func (_m *PostService) GetAllPosts(ctx context.Context) ([]model.Post, error) {
	ret := _m.Called(ctx)
...
func (_m *PostService) GetPostByID(ctx context.Context, id int) (*model.Post, error) {
